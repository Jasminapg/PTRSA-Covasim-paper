...
datemarks = pl.array([sim.day('2020-09-01'), sim.day('2020-11-01'), sim.day('2021-01-01'), sim.day('2021-03-01'), sim.day('2021-05-01'), sim.day('2021-07-01'), sim.day('2021-09-01')])-sim.day('2020-09-01')
...
#        ds = np.arange(0,len(tvec_d),1) # Downsample
#        thissim = msims[l].sims[0]
##        datatoplot = thissim.data['new_critical'][date_inds_d[0]:date_inds_d[1]]
#        pl.plot(tvec_d[ds], datatoplot[ds], 'd', c='k', markersize=12, alpha=0.75, label='Data')
#    toplot = plotdict['new_critical'][l][date_inds[0]:date_inds[1]]
#    pl.plot(tvec, toplot, c=colors[i], label=l, lw=4, alpha=1.0)
#    low = plotdict_l['new_critical'][l][date_inds[0]:date_inds[1]]
#    high = plotdict_h['new_critical'][l][date_inds[0]:date_inds[1]]
#    pl.fill_between(tvec, low, high, facecolor=colors[i], alpha=0.2)
#pl.ylabel('Daily ICUs')
#pl.axhline(1, linestyle=':', c='k', alpha=0.3)
#ax = pl.gca()
#ax.set_xticks(datemarks)
#cv.date_formatter(start_day=start_day, ax=ax, dateformat=dateformat)
